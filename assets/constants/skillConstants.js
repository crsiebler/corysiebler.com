...
export const skills = [
  ...
  },
  {
    title: 'Python',
    icons: [PythonIcon],
    body: 'Scripting and RESTful API development with Python3, Pyramid, Sphinx, Alembic, and Django.',
  },
  {
    title: 'Java',
  ...
  },
  {
    ...
    body: 'Generate Swagger documentation for API endpoints. Store reusable, extendable, and customizable React components in Storybook.',
  },
  {
    title: 'DevOps',
  ...
  },
  {
    title: 'IAM',
    icons: [Auth0Icon],
    body: 'Sign in, authorize, and manage users with Auth0 standards and Okta. Provide Single Sign-On (SSO) for platforms.',
  },
  {
    title: 'Databases',
    icons: [PostgresqlIcon, MysqlIcon, OracleIcon],
    body: 'Management, administration, and architecture for OLTP and OLAP databases. Familiar with Oracle, PostgreSQL, and MySQL DBMS.',
  },
  {
    title: 'Tools',
    icons: [RabbitMQIcon, RedisIcon, NginxIcon],
    body: 'RabbitMQ topics galore. In-memory data stores and caching with Redis. Nginx web server. Create reduncy and efficiency for your applications.',
  },
  {
