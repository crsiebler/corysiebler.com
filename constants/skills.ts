export const skills = {
  ...
  Tools: {
    description:
      'RabbitMQ topics galore. In-memory data stores and caching with Redis. Nginx web server. Create redundancy and efficiency for your applications.',
  ...
  'Cloud Computing': {
    description:
      'Utilize cloud infrastructure such as Heroku, Vercel, and AWS (Lambda, EC2, RDS, S3, Neptune).',
